...
export async function before(m, {conn, isAdmin, isBotAdmin, usedPrefix}) {
  ...
  const fakemek = {'key': {'participant': '0@s.whatsapp.net', 'remoteJid': '0@s.whatsapp.net'}, 'message': {'groupInviteMessage': {'groupJid': '56942528533-56942528533@g.us', 'inviteCode': 'm', 'groupName': 'P', 'caption': '𝐅𝐞𝐧𝐢𝐱 𝐁𝐨𝐭', 'jpegThumbnail': null}}};
